        ...
        <div className="flex items-center justify-between max-w-[1250px] mx-auto px-6 h-full space-x-8">
          ...
          <div className="hidden md:block">
            <ul className="flex space-x-5">
              <li>
                <NavLink
                  className={"cursor-pointer hover:text-[#da2f68]"}
                  to={"/"}
                >
                  Home
                </NavLink>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <button
              ...
              className="border-2 border-black rounded-lg p-2 hover:border-white"
            >
              Login
            </button>
            <button
      ...
      >
        <div className="px-5 py-[2rem]">
          ...
          <ul className="flex flex-col space-y-5">
            ...
            <li className="text-xl font-medium border-b pb-2 border-gray-900">
              <NavLink className={"cursor-pointer"} to={"/contact"}>
                Contact
              </NavLink>
            </li>
          </ul>
