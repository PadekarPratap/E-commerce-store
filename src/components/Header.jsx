        ...
        <div className="absolute inset-0 bg-black/50 text-white">
          <div className="mt-[8rem] max-w-[1200px] mx-auto px-5 text-center">
            ...
            <button
              ...
              className="bg-orange-500 px-4 py-1 font-medium md:text-2xl hover:shadow-xl"
            >
              Explore Now!
            </button>
          </div>
            ...
            <img
              ...
              className={
                currentIndex === slideIndex
                  ? "w-full h-[90vh] object-cover object-center"
                  : "hidden"
              }
              src={slide.imageUrl}
              alt=""
          ...
          return (
            ...
            >
              <div
                className={
                  currentIndex === slideIndex
                    ? "w-2 h-2 bg-white rounded-full border-4 border-blue-950"
